...
namespace Kelas.DataAccessLayer.Helper
{
    /// <summary>
    ...
    public class DbTransaction
    {
        ...
        private static string SqlConnectionString = ConfigurationManager.ConnectionStrings["KelasConnectionString"].ConnectionString;
